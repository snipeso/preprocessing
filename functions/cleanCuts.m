...
% function that interpolates snippets of bad data, and removes bad
% channels. Returns the EEG structure with interpolated data, and the
% matrix of segments TMPREJ that can then be highlighted or removed later.
% Script by Sophia Snipes, 22/04/21
